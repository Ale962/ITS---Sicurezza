...
# 1) devo leggere il file per intero
data = None

with open(sys.argv[1], 'rb') as f:
    data = f.read()

# 2) scelgo un byte casuale del file
...
# ora devo cambiare il valore del <bit> di data[pos] (uso lo xor)
# in sostanza devo costruire un byte di tutti O e un solo 1 nel posto giusto
